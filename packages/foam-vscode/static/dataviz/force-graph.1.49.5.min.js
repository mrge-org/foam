...
!(function (t, n) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(n)
    : ((t =
        'undefined' != typeof globalThis ? globalThis : t || self).ForceGraph =
        n());
})(this, function () {
  'use strict';
  function n(t, n) {
  ...
  function p(t) {
    ...
    return (
      ...
      f.hasOwnProperty(n) ? { space: f[n], local: t } : t
    );
  }
  function d(t) {
    return function () {
      var n = this.ownerDocument,
        e = this.namespaceURI;
      return e === h && n.documentElement.namespaceURI === h
        ? n.createElement(t)
  ...
  function P(t, n, e, r, i, o) {
    for (var a, u = 0, s = n.length, l = o.length; u < l; ++u)
      (a = n[u]) ? ((a.__data__ = o[u]), (r[u] = a)) : (e[u] = new C(t, o[u]));
    ...
    for (u = 0; u < f; ++u)
      (l = a.call(t, o[u], u, o) + ''),
        (s = c.get(l))
          ...
          : (e[u] = new C(t, o[u]));
    for (u = 0; u < h; ++u) (s = n[u]) && c.get(p[u]) === s && (i[u] = s);
  }
  function N(t) {
    return t.__data__;
  }
  ...
  function V(t, n) {
    return (
      ...
      q(t).getComputedStyle(t, null).getPropertyValue(n)
    );
  }
  function X(t) {
    return function () {
  ...
  function et(t, n) {
    return function () {
      (n.apply(this, arguments) ? K : J)(this, t);
    };
  }
  function rt() {
    this.textContent = '';
  ...
  bt.prototype = wt.prototype = {
    ...
    data: function (t, n) {
      ...
      for (
        ...
        var c = r[l],
          h = i[l],
          f = h.length,
          p = j(t.call(c, c && c.__data__, l, r)),
          d = p.length,
          g = (u[l] = new Array(d)),
          y = (a[l] = new Array(d));
        e(c, h, g, y, (s[l] = new Array(f)), p, n);
        for (var _, v, m = 0, x = 0; m < d; ++m)
          if ((_ = g[m])) {
            for (m >= x && (x = m + 1); !(v = y[x]) && ++x < d; );
            _._next = v || null;
          }
      }
    ...
    enter: function () {
      return new bt(this._enter || this._groups.map(E), this._parents);
    },
    exit: function () {
      return new bt(this._exit || this._groups.map(E), this._parents);
    },
    join: function (t, n, e) {
      var r = this.enter(),
        i = this,
    ...
    property: function (t, n) {
      return arguments.length > 1
        ? this.each((null == n ? X : 'function' == typeof n ? Y : G)(t, n))
        : this.node()[t];
    },
    ...
    insert: function (t, n) {
      var e = 'function' == typeof t ? t : y(t),
        r = null == n ? ht : 'function' == typeof n ? n : v(n);
      return this.select(function () {
    ...
    on: function (t, n, e) {
      var r,
        ...
        a = o.length;
      if (!(arguments.length < 2)) {
        for (u = n ? yt : gt, r = 0; r < a; ++r) this.each(u(o[r], n, e));
        return this;
      }
    ...
    dispatch: function (t, n) {
      return this.each(('function' == typeof n ? mt : vt)(t, n));
    },
    ...
    on: function (t, n) {
      ...
      if (!(arguments.length < 2)) {
        ...
        for (; ++a < u; )
          ...
          else if (null == n) for (e in i) i[e] = Ct(i[e], t.name, null);
        return this;
      }
      for (; ++a < u; )
  ...
  function Tt(t) {
    var n = t.document.documentElement,
      e = kt(t).on('dragstart.drag', jt, Ot);
    'onselectstart' in n
      ? e.on('selectstart.drag', jt, Ot)
      : ((n.__noselect = n.style.MozUserSelect),
        (n.style.MozUserSelect = 'none'));
  }
  function Rt(t, n) {
    var e = t.document.documentElement,
      r = kt(t).on('dragstart.drag', null);
    n &&
      (r.on('click.drag', jt, Ot),
      setTimeout(function () {
  ...
  var Vt = 0.7,
    ...
    Wt = '\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*',
    Zt = /^#([0-9a-f]{3,8})$/,
    Qt = new RegExp(`^rgb\\(${Gt},${Gt},${Gt}\\)$`),
    Kt = new RegExp(`^rgb\\(${Wt},${Wt},${Wt}\\)$`),
    Jt = new RegExp(`^rgba\\(${Gt},${Gt},${Gt},${Yt}\\)$`),
    tn = new RegExp(`^rgba\\(${Wt},${Wt},${Wt},${Yt}\\)$`),
    nn = new RegExp(`^hsl\\(${Yt},${Wt},${Wt}\\)$`),
    en = new RegExp(`^hsla\\(${Yt},${Wt},${Wt},${Yt}\\)$`),
    rn = {
      aliceblue: 15792383,
      ...
      (n = Zt.exec(t))
        ? ((e = n[1].length),
          ...
          6 === e
            ...
            : null)
        : (n = Qt.exec(t))
        ? new hn(n[1], n[2], n[3], 1)
        : (n = Kt.exec(t))
        ? new hn((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = Jt.exec(t))
        ? ln(n[1], n[2], n[3], n[4])
        : (n = tn.exec(t))
        ? ln((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = nn.exec(t))
  ...
  function cn(t, n, e, r) {
    return 1 === arguments.length
      ? (function (t) {
          return (
            t instanceof Ht || (t = un(t)),
            t ? new hn((t = t.rgb()).r, t.g, t.b, t.opacity) : new hn()
          );
        })(t)
  ...
  function pn() {
    ...
    return `${
      1 === t ? 'rgb(' : 'rgba('
    }${gn(this.r)}, ${gn(this.g)}, ${gn(this.b)}${1 === t ? ')' : `, ${t})`}`;
  }
  function dn(t) {
  ...
  function vn(t) {
    ...
    if ((t instanceof Ht || (t = un(t)), !t)) return new mn();
  ...
  $t(Ht, un, {
    ...
    $t(
      ...
      Bt(Ht, {
        brighter(t) {
          return (
            (t = null == t ? Xt : Math.pow(Xt, t)),
            new hn(this.r * t, this.g * t, this.b * t, this.opacity)
          );
        },
        darker(t) {
          return (
        ...
        clamp() {
          return new hn(gn(this.r), gn(this.g), gn(this.b), dn(this.opacity));
        },
        displayable() {
          return (
            -0.5 <= this.r &&
        ...
        formatHex: fn,
        formatHex8: function () {
          return `#${yn(this.r)}${yn(this.g)}${yn(this.b)}${yn(
    ...
    $t(
      ...
      Bt(Ht, {
        ...
        clamp() {
          return new mn(xn(this.h), bn(this.s), bn(this.l), dn(this.opacity));
        },
        displayable() {
          return (
  ...
  function Pn(t, n) {
    var e,
      r,
      i,
      o = (En.lastIndex = Cn.lastIndex = 0),
      a = -1,
      u = [],
      s = [];
    for (t += '', n += ''; (e = En.exec(t)) && (r = Cn.exec(n)); )
      (i = r.index) > o &&
      ...
      return (
        ...
        (function (t, r, i, o, a, u) {
          if (t !== i || r !== o) {
            ...
            u.push({ i: s - 4, x: Sn(t, i) }, { i: s - 2, x: Sn(r, o) });
  ...
  var Dn = Rn(
      function (t) {
        ...
        return n.isIdentity ? jn : Tn(n.a, n.b, n.c, n.d, n.e, n.f);
      },
      'px, ',
      'px)',
      'deg)'
        ...
        return null == t
          ...
          : (On ||
            ...
            (t = On.transform.baseVal.consolidate())
              ? Tn((t = t.matrix).a, t.b, t.c, t.d, t.e, t.f)
              : jn);
      },
      ', ',
      ')',
    ...
    qn = (function t(n, e, r) {
      function i(t, i) {
        ...
        if (g < 1e-12)
          ...
          var y = Math.sqrt(g),
            _ = (f * f - l * l + r * g) / (2 * l * e * y),
            v = (f * f - l * l - r * g) / (2 * f * e * y),
          ...
          (a = (x - m) / n),
            (o = function (t) {
              ...
              return [u + o * p, s + o * d, (l * i) / Un(n * r + m)];
            });
        }
  ...
  function te() {
    (Xn = (Vn = Yn.now()) + Gn), ($n = Bn = 0);
    try {
      !(function () {
        Zn(), ++$n;
        for (var t, n = Fn; n; )
          (t = Xn - n._time) >= 0 && n._call.call(void 0, t), (n = n._next);
        --$n;
      })();
    } finally {
      ($n = 0),
  ...
  function ee(t) {
    $n ||
      ...
      t - Xn > 24
        ? (t < 1 / 0 && (Bn = setTimeout(te, t - Yn.now() - Gn)),
          Hn && (Hn = clearInterval(Hn)))
        : (Hn || ((Vn = Yn.now()), (Hn = setInterval(ne, 1e3))),
          ($n = 1),
          Wn(te)));
  }
  function re(t, n, e) {
  ...
  Kn.prototype = Jn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? Zn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          Ln === this ||
          (Ln ? (Ln._next = this) : (Fn = this), (Ln = this)),
        (this._call = t),
        (this._time = e),
        ee();
    },
  ...
  var ie = zt('start', 'end', 'cancel', 'interrupt'),
    oe = [];
  ...
  function Ae(t, n) {
    return function () {
      se(this, t).duration = +n.apply(this, arguments);
    };
  }
  function ze(t, n) {
    return (
      (n = +n),
      function () {
        se(this, t).duration = n;
      }
    );
  }
  var Se = wt.prototype.constructor;
  function Ee(t) {
    return function () {
      this.style.removeProperty(t);
    };
  ...
  Pe.prototype = {
    ...
    attr: function (t, n) {
      ...
      return this.attrTween(
        t,
        'function' == typeof n
          ? (e.local ? xe : me)(e, r, pe(this, 'attr.' + t, n))
          : null == n
          ? (e.local ? ye : ge)(e)
          : (e.local ? ve : _e)(e, r, n)
      );
    ...
    attrTween: function (t, n) {
      ...
      var r = p(t);
      return this.tween(e, (r.local ? be : we)(r, n));
    },
    style: function (t, n, e) {
      var r = 'transform' == (t += '') ? Dn : de;
      return null == n
        ? this.styleTween(
            t,
            (function (t, n) {
              ...
              return function () {
                var o = V(this, t),
                  a = (this.style.removeProperty(t), V(this, t));
                return o === a
                  ? null
                  : o === e && a === r
                  ? i
        ...
        ? this.styleTween(
            ...
            (function (t, n, e) {
              ...
              return function () {
                ...
                return (
                  null == u &&
                    (this.style.removeProperty(t), (s = u = V(this, t))),
                  a === s
                    ? null
                    : a === r && s === i
                    ? o
    ...
    tween: function (t, n) {
      ...
      if (((t += ''), arguments.length < 2)) {
        for (
          var r, i = le(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
    ...
    delay: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(('function' == typeof t ? ke : Me)(n, t))
        : le(this.node(), n).delay;
    },
    duration: function (t) {
      var n = this._id;
      return arguments.length
        ? this.each(('function' == typeof t ? Ae : ze)(n, t))
        : le(this.node(), n).duration;
    },
    ease: function (t) {
      var n = this._id;
      return arguments.length
  ...
  (wt.prototype.interrupt = function (t) {
    ...
    (wt.prototype.transition = function (t) {
      ...
      t instanceof Pe
        ? ((n = t._id), (t = t._name))
        : ((n = Oe()), ((e = je).time = Zn()), (t = null == t ? null : t + ''));
      for (var r = this._groups, i = r.length, o = 0; o < i; ++o)
        for (var a, u = r[o], s = u.length, l = 0; l < s; ++l)
          (a = u[l]) && ae(a, t, n, l, u, e || Te(a, n));
      return new Pe(r, this._parents, t, n);
    });
  var Re = t => () => t;
  function De(t, { sourceEvent: n, target: e, transform: r, dispatch: i }) {
    Object.defineProperties(this, {
      type: { value: t, enumerable: !0, configurable: !0 },
      sourceEvent: { value: n, enumerable: !0, configurable: !0 },
  ...
  Ie.prototype = {
    ...
    translate: function (t, n) {
      return (0 === t) & (0 === n)
        ? this
        : new Ie(this.k, this.x + this.k * t, this.y + this.k * n);
    },
    apply: function (t) {
  ...
  function Ye() {
        ...
        .tween('zoom', function () {
          ...
          return function (t) {
            if (1 === t) t = f;
              ...
              var n = p(t),
                e = l / n[2];
              t = new Ie(e, s[0] - n[0] * e, s[1] - n[1] * e);
            }
            a.zoom(null, t);
          };
        });
    ...
    function w(t, ...n) {
      if (r.apply(this, arguments)) {
        ...
        if (e.wheel)
          ...
          if (i.k === u) return;
          (e.mouse = [c, i.invert(c)]), ce(this), e.start();
        }
        qe(t),
          (e.wheel = setTimeout(function () {
            (e.wheel = null), e.end();
          }, 150)),
          e.zoom('mouse', o(_(y(i, u), e.mouse[0], e.mouse[1]), e.extent, l));
      }
    }
    function k(t, ...n) {
            ...
            .on(
              ...
              function (t) {
                ...
                a.event(t).zoom(
                  'mouse',
                  o(
                    _(a.that.__zoom, (a.mouse[0] = Mt(t, i)), a.mouse[1]),
                    a.extent,
                    l
                  )
                );
    ...
    function M(t, ...n) {
      if (r.apply(this, arguments)) {
        var e = this.__zoom,
          a = Mt(t.changedTouches ? t.changedTouches[0] : t, this),
          u = e.invert(a),
          s = e.k * (t.shiftKey ? 0.5 : 2),
          h = o(_(y(e, s), a, u), i.apply(this, n), l);
        qe(t),
          c > 0
            ? kt(this).transition().duration(c).call(m, h, a, t)
            : kt(this).call(g.transform, h, a, t);
      }
    }
    function A(e, ...i) {
      if (r.apply(this, arguments)) {
        var o,
          ...
          l = e.touches,
          c = l.length,
          h = x(this, i, e.changedTouches.length === c).event(e);
        for (Le(e), a = 0; a < c; ++a)
          (s = [
            (s = Mt((u = l[a]), this)),
    ...
    function S(t, ...r) {
      if (this.__zooming) {
        ...
        if (
          ...
          (a.end(),
          2 === a.taps &&
            ((o = Mt(o, this)), Math.hypot(n[0] - o[0], n[1] - o[1]) < d))
        ) {
          var l = kt(this).on('dblclick.zoom');
    ...
    return (
      ...
      (g.translateTo = function (t, n, e, r, a) {
        g.transform(
          t,
          function () {
            var t = i.apply(this, arguments),
      ...
      (g.wheelDelta = function (t) {
        return arguments.length
          ? ((a = 'function' == typeof t ? t : Re(+t)), g)
          : a;
      }),
      (g.filter = function (t) {
        return arguments.length
          ? ((r = 'function' == typeof t ? t : Re(!!t)), g)
          : r;
      }),
      (g.touchable = function (t) {
        return arguments.length
          ? ((u = 'function' == typeof t ? t : Re(!!t)), g)
          : u;
      }),
      (g.extent = function (t) {
        return arguments.length
  ...
  class We extends Map {
    ...
    get(t) {
      return super.get(Ze(this, t));
    }
    has(t) {
      return super.has(Ze(this, t));
    }
    set(t, n) {
      return super.set(
  ...
  function Ze({ _intern: t, _key: n }, e) {
    const r = n(e);
  ...
  var tr =
    ...
    ar = ir.toString,
    ur = rr ? rr.toStringTag : void 0;
  var sr = Object.prototype.toString;
  var lr = rr ? rr.toStringTag : void 0;
  function cr(t) {
    return null == t
      ? void 0 === t
        ? '[object Undefined]'
      ...
      ? (function (t) {
          ...
          var i = ar.call(t);
          return r && (n ? (t[ur] = e) : delete t[ur]), i;
        })(t)
      : (function (t) {
          return sr.call(t);
        })(t);
  ...
  function mr(t) {
    ...
    t = pr(t);
    var e = yr.test(t);
    return e || _r.test(t) ? vr(t.slice(2), e ? 2 : 8) : gr.test(t) ? NaN : +t;
  }
  var xr = function () {
      return er.Date.now();
    },
  ...
  function kr(t, n, e) {
    ...
    function _() {
      ...
      if (((r = arguments), (i = this), (s = t), e)) {
        if (void 0 === u)
          return (function (t) {
            return (l = t), (u = setTimeout(g, n)), c ? p(t) : a;
          })(s);
        if (h) return clearTimeout(u), (u = setTimeout(g, n)), p(s);
      }
  ...
  var Mr = Object.freeze({
      ...
      Bounce: Object.freeze({
        ...
        InOut: function (t) {
          return t < 0.5
            ? 0.5 * Mr.Bounce.In(2 * t)
            : 0.5 * Mr.Bounce.Out(2 * t - 1) + 0.5;
        },
      }),
      ...
      return (
        ...
        (t.prototype.add = function () {
          ...
          for (var r = 0, i = n; r < i.length; r++) {
            var o = i[r];
            null === (t = o._group) || void 0 === t || t.remove(o),
              (o._group = this),
    ...
    Pr = (function () {
      function t(t, n) {
        (this._isPaused = !1),
          ...
          (this._delayTime = 0),
          (this._startTime = 0),
          (this._easingFunction = Mr.Linear.None),
          (this._interpolationFunction = Sr.Linear),
          (this._chainedTweens = []),
          ...
          'object' == typeof n
            ...
            : !0 === n && ((this._group = Cr), Cr.add(this));
      }
      return (
            ...
            if ('undefined' !== s && 'function' !== s) {
              if (l) {
                ...
                for (var c = [a], h = 0, f = y.length; h < f; h += 1) {
                  var p = this._handleRelativeValue(a, y[h]);
                  if (isNaN(p)) {
                    (l = !1),
                      console.warn(
              ...
              if (('object' !== s && !u) || !a || l)
                ...
                n[o] = u ? [] : {};
                var d = a;
                for (var g in d) n[o][g] = d[g];
                r[o] = u ? [] : {};
                var y = e[o];
                if (!this._isDynamic) {
                  var _ = {};
                  for (var g in y) _[g] = y[g];
                  e[o] = y = _;
                }
                this._setupProperties(d, n[o], y, r[o], i);
              }
            }
          }
        }),
        ...
        (t.prototype.update = function (n, e) {
          ...
          if (
            (void 0 === n && (n = Ar()),
            void 0 === e && (e = t.autoStartOnUpdate),
            this._isPaused)
          )
            return !0;
          ...
          if (
            ...
            if (this._repeat > 0) {
              var h = Math.min(
                Math.trunc((a - this._duration) / u) + 1,
                this._repeat
              );
              for (i in (isFinite(this._repeat) && (this._repeat -= h),
              this._valuesStartRepeat))
                this._yoyo ||
  ...
  function Tr(t, n) {
    return (
      ...
      (function (t, n) {
        if (t) {
          if ('string' == typeof t) return Nr(t, n);
  ...
  Or.getAll.bind(Or),
    Or.removeAll.bind(Or),
    Or.add.bind(Or),
    Or.remove.bind(Or),
    Or.update.bind(Or);
  var Rr = jr(function t(n, e) {
    var r = e.default,
      i = void 0 === r ? null : r,
      o = e.triggerUpdate,
      a = void 0 === o || o,
  ...
  function Dr(t) {
    ...
    return function t() {
      ...
      var o = !!(this instanceof t ? this.constructor : void 0),
        ...
        l = r[0],
        h = void 0 === l ? {} : l,
        d = Object.assign({}, e instanceof Function ? e(h) : e, {
          initialised: !1,
        }),
        g = {};
      function y(t) {
      ...
      var _ = function (t, n) {
          c.call(y, t, d, n), (d.initialised = !0);
        },
        v = kr(function () {
          d.initialised && (f.call(y, d, g), (g = {}));
        }, 1);
      return (
        ...
        Object.keys(a).forEach(function (t) {
          y[t] = function () {
            for (
              ...
              r[i] = arguments[i];
            return (n = a[t]).call.apply(n, [y, d].concat(r));
          };
        }),
        ...
        (y.resetProps = function () {
          return (
            p.forEach(function (t) {
              y[t.name](t.defaultVal);
            }),
            y
          );
        }),
  ...
  function qr(t, n) {
    ...
    var e = (function (t) {
      ...
      'string' == typeof t &&
        (t = (function (t) {
          t = t.replace(Fr, '').replace(Lr, '').toLowerCase();
          var n,
            e = !1;
          if (ii[t]) (t = ii[t]), (e = !0);
          else if ('transparent' == t)
            return { r: 0, g: 0, b: 0, a: 0, format: 'name' };
          if ((n = _i.rgb.exec(t))) return { r: n[1], g: n[2], b: n[3] };
          if ((n = _i.rgba.exec(t)))
            return { r: n[1], g: n[2], b: n[3], a: n[4] };
          if ((n = _i.hsl.exec(t))) return { h: n[1], s: n[2], l: n[3] };
          if ((n = _i.hsla.exec(t)))
            return { h: n[1], s: n[2], l: n[3], a: n[4] };
          if ((n = _i.hsv.exec(t))) return { h: n[1], s: n[2], v: n[3] };
          if ((n = _i.hsva.exec(t)))
      ...
      'object' == Ur(t) &&
        (vi(t.r) && vi(t.g) && vi(t.b)
          ...
          : vi(t.h) && vi(t.s) && vi(t.v)
          ? ((r = hi(t.s)),
            (i = hi(t.v)),
            (n = (function (t, n, e) {
              (t = 6 * ui(t, 360)), (n = ui(n, 100)), (e = ui(e, 100));
              var r = Math.floor(t),
                i = t - r,
                o = e * (1 - n),
                a = e * (1 - i * n),
          ...
          : vi(t.h) &&
            ...
            (n = (function (t, n, e) {
              ...
              if (
                ((t = ui(t, 360)), (n = ui(n, 100)), (e = ui(e, 100)), 0 === n)
              )
                r = i = o = e;
              else {
  ...
  function $r(t, n, e) {
    (t = ui(t, 255)), (n = ui(n, 255)), (e = ui(e, 255));
    var r,
      i,
      o = Math.max(t, n, e),
      a = Math.min(t, n, e),
  ...
  function Hr(t, n, e, r) {
    var i = [
      ci(Math.round(t).toString(16)),
      ci(Math.round(n).toString(16)),
      ci(Math.round(e).toString(16)),
    ];
    return r &&
  ...
  function Xr(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = qr(t).toHsl();
    return (e.s -= n / 100), (e.s = si(e.s)), qr(e);
  }
  function Gr(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = qr(t).toHsl();
  ...
  function Wr(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = qr(t).toHsl();
    return (e.l += n / 100), (e.l = si(e.l)), qr(e);
  }
  function Zr(t, n) {
    n = 0 === n ? 0 : n || 10;
    var e = qr(t).toRgb();
  ...
  function ti(t, n) {
    ...
    for (var e = qr(t).toHsl(), r = [qr(t)], i = 360 / n, o = 1; o < n; o++)
      r.push(qr({ h: (e.h + o * i) % 360, s: e.s, l: e.l }));
    return r;
  }
  function ni(t) {
    var n = qr(t).toHsl(),
    ...
    return [
      qr(t),
      qr({ h: (e + 72) % 360, s: n.s, l: n.l }),
      qr({ h: (e + 216) % 360, s: n.s, l: n.l }),
    ];
  }
  function ei(t, n, e) {
    (n = n || 6), (e = e || 30);
    ...
    for (r.h = (r.h - ((i * n) >> 1) + 720) % 360; --n; )
      (r.h = (r.h + i) % 360), o.push(qr(r));
    return o;
  }
  function ri(t, n) {
    n = n || 6;
    for (
      var e = qr(t).toHsv(), r = e.h, i = e.s, o = e.v, a = [], u = 1 / n;
      n--;

    )
      a.push(qr({ h: r, s: i, v: o })), (o = (o + u) % 1);
    return a;
  }
  (qr.prototype = {
    isDark: function () {
    ...
    toHex: function (t) {
      return Hr(this._r, this._g, this._b, t);
    },
    ...
    toPercentageRgb: function () {
      return {
        r: Math.round(100 * ui(this._r, 255)) + '%',
        g: Math.round(100 * ui(this._g, 255)) + '%',
        b: Math.round(100 * ui(this._b, 255)) + '%',
        a: this._a,
      };
    },
    toPercentageRgbString: function () {
      return 1 == this._a
        ? 'rgb(' +
            Math.round(100 * ui(this._r, 255)) +
            '%, ' +
            Math.round(100 * ui(this._g, 255)) +
            '%, ' +
            Math.round(100 * ui(this._b, 255)) +
            '%)'
        : 'rgba(' +
            Math.round(100 * ui(this._r, 255)) +
            '%, ' +
    ...
    toName: function () {
      return 0 === this._a
        ? 'transparent'
        : !(this._a < 1) && (oi[Hr(this._r, this._g, this._b, !0)] || !1);
    },
    toFilter: function (t) {
      var n = '#' + Vr(this._r, this._g, this._b, this._a),
        e = n,
        r = this._gradientType ? 'GradientType = 1, ' : '';
      if (t) {
        var i = qr(t);
        e = '#' + Vr(i._r, i._g, i._b, i._a);
      }
      return (
    ...
    splitcomplement: function () {
      return this._applyCombination(ni, arguments);
    },
    triad: function () {
      return this._applyCombination(ti, [3]);
    },
    tetrad: function () {
      return this._applyCombination(ti, [4]);
    },
  }),
    (qr.fromRatio = function (t, n) {
      if ('object' == Ur(t)) {
        var e = {};
        for (var r in t)
          t.hasOwnProperty(r) && (e[r] = 'a' === r ? t[r] : hi(t[r]));
        t = e;
      }
      return qr(t, n);
    }),
    ...
    (qr.mostReadable = function (t, n, e) {
      ...
      for (var l = 0; l < n.length; l++)
        (r = qr.readability(t, n[l])) > s && ((s = r), (u = qr(n[l])));
      return qr.isReadable(t, u, { level: o, size: a }) || !i
        ? u
        : ((e.includeFallbackColors = !1),
          qr.mostReadable(t, ['#fff', '#000'], e));
    });
  var ii = (qr.names = {
      aliceblue: 'f0f8ff',
      antiquewhite: 'faebd7',
  ...
  function xi(t, n, e) {
    if ('function' == typeof t ? t === n : t.has(n))
  ...
  function Ai(t) {
    return (
      ...
      (function (t, n) {
        if (t) {
          if ('string' == typeof t) return mi(t, n);
          var e = {}.toString.call(t).slice(8, -1);
          return (
            'Object' === e && t.constructor && (e = t.constructor.name),
            'Map' === e || 'Set' === e
        ...
        [
          {
            key: 'reset',
            value: function () {
              ki(qi, this, ['__reserved for background__']);
            },
          },
          {
            key: 'register',
            value: function (t) {
              if (bi(qi, this).length >= Math.pow(2, 24 - bi($i, this)))
                return null;
              var n,
                e = bi(qi, this).length,
                r = Li(e, bi($i, this)),
            ...
            value: function (t) {
              ...
              var n =
                'string' == typeof t
                  ...
                  : Fi.apply(void 0, Ai(t));
              if (!n) return null;
              var e = n & (Math.pow(2, 24 - bi($i, this)) - 1),
                r =
                  (n >> (24 - bi($i, this))) & (Math.pow(2, bi($i, this)) - 1);
              return Li(e, bi($i, this)) !== r || e >= bi(qi, this).length
                ? null
                : bi(qi, this)[e];
            },
          },
  ...
  function Ji(t, n) {
    if (null == n) return t.__ ? Ji(t.__, t.__i + 1) : null;
    for (var e; n < t.__k.length; n++)
      if (null != (e = t.__k[n]) && null != e.__e) return e.__e;
    return 'function' == typeof t.type ? Ji(t) : null;
  }
  function to(t) {
    var n, e;
  ...
  function no(t) {
    ((!t.__d && (t.__d = !0) && Oi.push(t) && !eo.__r++) ||
      Ni !== Ei.debounceRendering) &&
      ((Ni = Ei.debounceRendering) || ji)(eo);
  }
  function eo() {
    for (var t, n, e, r, i, o, a, u = 1; Oi.length; )
      Oi.length > u && Oi.sort(Ti),
        (t = Oi.shift()),
        (u = Oi.length),
        t.__d &&
          ((e = void 0),
  ...
  function ro(t, n, e, r, i, o, a, u, s, l, c) {
    var h,
      f,
      p,
      d,
      ...
      _ = (r && r.__k) || Vi,
      v = n.length;
    for (s = io(e, n, _, s, v), h = 0; h < v; h++)
      null != (p = e.__k[h]) &&
        ((f = -1 === p.__i ? Hi : _[p.__i] || Hi),
        (p.__i = h),
        (y = co(t, p, f, i, o, a, u, s, l, c)),
        (d = p.__e),
        p.ref &&
          f.ref != p.ref &&
          (f.ref && go(f.ref, null, p), c.push(p.ref, p.__c || d, p)),
        null == g && null != d && (g = d),
        4 & p.__u || f.__k === p.__k
          ? (s = oo(p, s, t))
  ...
  function io(t, n, e, r, i) {
    ...
    for (t.__k = new Array(i), o = 0; o < i; o++)
      null != (a = n[o]) && 'boolean' != typeof a && 'function' != typeof a
        ? ((s = o + f),
          ((a = t.__k[o] =
            'string' == typeof a ||
            'number' == typeof a ||
            ...
            a.constructor == String
              ? Zi(null, a, null, null, null)
              : Gi(a)
              ? Zi(Qi, { children: a }, null, null, null)
              : void 0 === a.constructor && a.__b > 0
              ? Zi(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v)
              : a).__ = t),
          (a.__b = t.__b + 1),
          (u = null),
          -1 !== (l = a.__i = ao(a, e, s, h)) &&
            (h--, (u = e[l]) && (u.__u |= 2)),
          null == u || null === u.__v
            ? (-1 == l && (i > c ? f-- : i < c && f++),
  ...
  function oo(t, n, e) {
    ...
    if ('function' == typeof t.type) {
      for (r = t.__k, i = 0; r && i < r.length; i++)
        r[i] && ((r[i].__ = t), (n = oo(r[i], n, e)));
      return n;
    }
    t.__e != n &&
      (n && t.type && !e.contains(n) && (n = Ji(t)),
      e.insertBefore(t.__e, n || null),
      (n = t.__e));
    do {
      n = n && n.nextSibling;
  ...
  function ao(t, n, e, r) {
    ...
    if (
      (null === s && null == t.key) ||
      (s && a == s.key && u === s.type && !(2 & s.__u))
    )
      return e;
    if (r > (null == s || 2 & s.__u ? 0 : 1))
      for (i = e - 1, o = e + 1; i >= 0 || o < n.length; ) {
        if (i >= 0) {
          if ((s = n[i]) && !(2 & s.__u) && a == s.key && u === s.type)
            return i;
          i--;
        }
        if (o < n.length) {
          if ((s = n[o]) && !(2 & s.__u) && a == s.key && u === s.type)
            return o;
          o++;
        }
      }
  ...
  function uo(t, n, e) {
    '-' == n[0]
      ...
      : (t[n] =
          null == e ? '' : 'number' != typeof e || Xi.test(n) ? e : e + 'px');
  }
    ...
    t: if ('style' == n)
      if ('string' == typeof e) t.style.cssText = e;
        ...
        if (('string' == typeof r && (t.style.cssText = r = ''), r))
          for (n in r) (e && n in e) || uo(t.style, n, '');
        if (e) for (n in e) (r && e[n] === r[n]) || uo(t.style, n, e[n]);
      }
    else if ('o' == n[0] && 'n' == n[1])
      (o = n != (n = n.replace(Ri, '$1'))),
        (n =
        ...
        e
          ? r
            ? (e.t = r.t)
            : ((e.t = Di), t.addEventListener(n, o ? Ui : Ii, o))
          : t.removeEventListener(n, o ? Ui : Ii, o);
    else {
  ...
  function lo(t) {
    return function (n) {
      if (this.l) {
        ...
        if (null == n.u) n.u = Di++;
        else if (n.u < e.t) return;
        return e(Ei.event ? Ei.event(n) : n);
      }
    };
  }
  function co(t, n, e, r, i, o, a, u, s, l) {
    var c,
      h,
      f,
      p,
    ...
    128 & e.__u && ((s = !!(32 & e.__u)), (o = [(u = n.__e = e.__e)])),
      (c = Ei.__b) && c(n);
    t: if ('function' == typeof S)
      try {
        if (
          ...
          (x = c ? (m ? m.props.value : c.__) : r),
          e.__c
            ? (y = (h = n.__c = e.__c).__ = h.__E)
            : (v
                ? (n.__c = h = new S(_, x))
                : ((n.__c = h = new Ki(_, x)),
                  (h.constructor = S),
              ...
              (h.__h = []),
              (h._sb = [])),
          v && null == h.__s && (h.__s = h.state),
          v &&
            null != S.getDerivedStateFromProps &&
            (h.__s == h.state && (h.__s = Yi({}, h.__s)),
            Yi(h.__s, S.getDerivedStateFromProps(_, h.__s))),
          (p = h.props),
          (d = h.state),
          (h.__v = n),
          f)
          ...
          v &&
            ...
            v && null != h.componentDidMount && h.__h.push(h.componentDidMount);
        else {
          if (
            (v &&
              null == S.getDerivedStateFromProps &&
              ...
              h.componentWillReceiveProps(_, x),
            !h.__e &&
              ((null != h.shouldComponentUpdate &&
                !1 === h.shouldComponentUpdate(_, h.__s, x)) ||
                n.__v == e.__v))
          ) {
            for (
              n.__v != e.__v &&
          ...
          null != h.componentWillUpdate && h.componentWillUpdate(_, h.__s, x),
            v &&
              null != h.componentDidUpdate &&
              h.__h.push(function () {
                h.componentDidUpdate(p, d, g);
              });
        }
        if (
          ((h.context = x),
        ...
        (h.state = h.__s),
          null != h.getChildContext && (r = Yi(Yi({}, r), h.getChildContext())),
          v &&
            !f &&
            null != h.getSnapshotBeforeUpdate &&
            (g = h.getSnapshotBeforeUpdate(p, d)),
          (A = c),
          null != c &&
            c.type === Qi &&
            null == c.key &&
            (A = fo(c.props.children)),
          (u = ro(t, Gi(A) ? A : [A], n, e, r, i, o, a, u, s, l)),
          (h.base = n.__e),
          (n.__u &= -161),
      ...
      null == o && n.__v == e.__v
        ...
        : (u = n.__e = po(e.__e, n, e, r, i, o, a, s, l));
    return (c = Ei.diffed) && c(n), 128 & n.__u ? void 0 : u;
  }
  function ho(t, n, e) {
    for (var r = 0; r < e.length; r++) go(e[r], e[++r], e[++r]);
    Ei.__c && Ei.__c(n, t),
      t.some(function (n) {
        try {
          (t = n.__h),
  ...
  function po(t, n, e, r, i, o, a, u, s) {
    ...
    if (null == t) {
      ...
      (t = document.createElementNS(i, v, _.is && _)),
        u && (Ei.__m && Ei.__m(n, o), (u = !1)),
        (o = null);
    }
    if (null === v) y === _ || (u && t.data === _) || (t.data = _);
    else {
      if (
        ((o = o && Si.call(t.childNodes)), (y = e.props || Hi), !u && null != o)
      )
        for (y = {}, l = 0; l < t.attributes.length; l++)
          y[(p = t.attributes[l]).name] = p.value;
      for (l in y)
        if (((p = y[l]), 'children' == l));
        else if ('dangerouslySetInnerHTML' == l) h = p;
        else if (!(l in _)) {
          if (
  ...
  function yo(t, n, e) {
    var r, i;
    if (
      (Ei.unmount && Ei.unmount(t),
      (r = t.ref) && ((r.current && r.current !== t.__e) || go(r, null, n)),
      null != (r = t.__c))
    ) {
    ...
    if ((r = t.__k))
      for (i = 0; i < r.length; i++)
        r[i] && yo(r[i], n, e || 'function' != typeof t.type);
    e || Wi(t.__e), (t.__c = t.__ = t.__e = void 0);
  }
  function _o(t, n, e) {
        ...
        (t = n.__k =
          (function (t, n, e) {
            var r,
              ...
              a = {};
            for (o in n)
              'key' == o ? (r = n[o]) : 'ref' == o ? (i = n[o]) : (a[o] = n[o]);
            if (
              (arguments.length > 2 &&
                (a.children = arguments.length > 3 ? Si.call(arguments, 2) : e),
              'function' == typeof t && null != t.defaultProps)
            )
              for (o in t.defaultProps)
                void 0 === a[o] && (a[o] = t.defaultProps[o]);
            return Zi(t, a, r, i, null);
          })(Qi, null, [t])),
        r || Hi,
        Hi,
        n.namespaceURI,
        r ? null : n.firstChild ? Si.call(n.childNodes) : null,
        i,
  ...
  function mo(t, n, e) {
    var r,
      ...
      a,
      u = Yi({}, t.props);
    for (o in (t.type && t.type.defaultProps && (a = t.type.defaultProps), n))
      'key' == o
        ? (r = n[o])
        : 'ref' == o
        ? (i = n[o])
        : (u[o] = void 0 === n[o] && void 0 !== a ? a[o] : n[o]);
    return (
      arguments.length > 2 &&
        (u.children = arguments.length > 3 ? Si.call(arguments, 2) : e),
      Zi(t.type, u, r || t.key, i || t.ref, null)
    );
  }
  function xo(t, n) {
    (null == n || n > t.length) && (n = t.length);
    ...
    (Ki.prototype.setState = function (t, n) {
      ...
      (e =
        null != this.__s && this.__s !== this.state
          ? this.__s
          : (this.__s = Yi({}, this.state))),
        'function' == typeof t && (t = t(Yi({}, e), this.props)),
        t && Yi(e, t),
        null != t && this.__v && (n && this._sb.push(n), no(this));
    }),
    (Ki.prototype.forceUpdate = function (t) {
      this.__v && ((this.__e = !0), t && this.__h.push(t), no(this));
    }),
    (Ki.prototype.render = Qi),
    (Oi = []),
    (ji =
    ...
    e.props &&
      ((e.props = (function (t) {
        for (var n = 1; n < arguments.length; n++) {
          var e = null != arguments[n] ? arguments[n] : {};
          n % 2
            ? wo(Object(e), !0).forEach(function (n) {
                bo(t, n, e[n]);
              })
            : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(t, Object.getOwnPropertyDescriptors(e))
            : wo(Object(e)).forEach(function (n) {
      ...
      null != e &&
        ...
        void 0 !== n &&
        n.children &&
        (e.props.children = Array.isArray(e.props.children)
          ? e.props.children.map(Ao)
          : Ao(e.props.children)));
    return e;
  };
  !(function (t, n) {
  ...
  var zo = Dr({
    ...
    init: function (t, n) {
      var e = (
        ...
        r = void 0 === e ? {} : e,
        i = kt(
          !!t && 'object' === Mo(t) && !!t.node && 'function' == typeof t.node
            ? t.node()
            : t
        );
      'static' === i.style('position') && i.style('position', 'relative'),
        (n.tooltipEl = i.append('div').attr('class', 'float-tooltip-kap')),
      ...
      (n.mouseInside = !1),
        i.on('mousemove.'.concat(o), function (t) {
          n.mouseInside = !0;
          var e = Mt(t),
            r = i.node(),
            o = r.offsetWidth,
            a = r.offsetHeight,
            u = [
              null === n.offsetX || void 0 === n.offsetX
                ? '-'.concat((e[0] / o) * 100, '%')
                : 'number' == typeof n.offsetX
                ? 'calc(-50% + '.concat(n.offsetX, 'px)')
                : n.offsetX,
              null === n.offsetY || void 0 === n.offsetY
                ? a > 130 && a - e[1] < 100
                  ? 'calc(-100% - 6px)'
                  : '21px'
                : 'number' == typeof n.offsetY
                ? n.offsetY < 0
                  ? 'calc(-100% - '.concat(Math.abs(n.offsetY), 'px)')
                  : ''.concat(n.offsetY, 'px')
                : n.offsetY,
            ];
          n.tooltipEl
            .style('left', e[0] + 'px')
            .style('top', e[1] + 'px')
            .style('transform', 'translate('.concat(u.join(','), ')')),
  ...
  function Oo(t, n) {
    var e = new No(null == n ? Po : n, NaN, NaN);
  ...
  var To = (Oo.prototype = No.prototype);
  function Ro(t, n, e, r) {
    ...
    if (
      ...
      return (d.next = p), i ? (i[h] = d) : (t._root = d), t;
    do {
  ...
  function Fo(t, n, e) {
    var r = new Lo(null == n ? Io : n, null == e ? Uo : e, NaN, NaN, NaN, NaN);
  ...
  (To.copy = function () {
    var t,
      n,
      e = new No(this._x, this._x0, this._x1),
      r = this._root;
    if (!r) return e;
    ...
    (To.add = function (t) {
      ...
      return Eo(this.cover(n), n, t);
    }),
    (To.addAll = function (t) {
      ...
      let r = 1 / 0,
        i = -1 / 0;
      for (let o, a = 0; a < n; ++a)
        isNaN((o = +this._x.call(null, t[a]))) ||
          ((e[a] = o), o < r && (r = o), o > i && (i = o));
      if (r > i) return this;
      this.cover(r).cover(i);
      for (let r = 0; r < n; ++r) Eo(this, e[r], t[r]);
      return this;
    }),
    (To.cover = function (t) {
    ...
    (To.find = function (t, n) {
      ...
      for (
        ...
        if (!(!(c = o.node) || (r = o.x0) > s || (i = o.x1) < u))
          if (c.length) {
            var h = (r + i) / 2;
            l.push(new Co(c[1], h, i), new Co(c[0], r, h)),
              (a = +(t >= h)) &&
                ((o = l[l.length - 1]),
    ...
    (To.visit = function (t) {
      var n,
        ...
        o = [],
        a = this._root;
      for (a && o.push(new Co(a, this._x0, this._x1)); (n = o.pop()); )
        if (!t((a = n.node), (r = n.x0), (i = n.x1)) && a.length) {
          var u = (r + i) / 2;
          (e = a[1]) && o.push(new Co(e, u, i)),
            (e = a[0]) && o.push(new Co(e, r, u));
        }
      return this;
    }),
    (To.visitAfter = function (t) {
      var n,
        e = [],
        r = [];
      for (
        this._root && e.push(new Co(this._root, this._x0, this._x1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            u = n.x1,
            s = (a + u) / 2;
          (o = i[0]) && e.push(new Co(o, a, s)),
            (o = i[1]) && e.push(new Co(o, s, u));
        }
        r.push(n);
      }
  ...
  var $o = (Fo.prototype = Lo.prototype);
  function Bo(t, n, e, r, i) {
    ...
    for (; _.length; )
      if (
        ...
        return (o[g] = v), t;
    if (
      ((l = +t._x.call(null, _.data)),
      (c = +t._y.call(null, _.data)),
      (h = +t._z.call(null, _.data)),
      n === l && e === c && r === h)
    )
      return (v.next = _), o ? (o[g] = v) : (t._root = v), t;
    do {
  ...
  ($o.copy = function () {
    var t,
      n,
      e = new Lo(this._x, this._y, this._x0, this._y0, this._x1, this._y1),
      r = this._root;
    if (!r) return e;
    if (!r.length) return (e._root = qo(r)), e;
    ...
    ($o.add = function (t) {
      ...
      return Ro(this.cover(n, e), n, e, t);
    }),
    ($o.addAll = function (t) {
      var n,
        e,
    ...
    ($o.find = function (t, n, e) {
      var r,
        ...
        g = this._root;
      for (
        g && d.push(new Do(g, c, h, f, p)),
          null == e
            ? (e = 1 / 0)
            : ((c = t - e), (h = n - e), (f = t + e), (p = n + e), (e *= e));
        (s = d.pop());
    ...
    ($o.visit = function (t) {
      var n,
        ...
        s = this._root;
      for (
        s && u.push(new Do(s, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());
        ...
        if (
          ...
          var l = (r + o) / 2,
            c = (i + a) / 2;
          (e = s[3]) && u.push(new Do(e, l, c, o, a)),
            (e = s[2]) && u.push(new Do(e, r, c, l, a)),
            (e = s[1]) && u.push(new Do(e, l, i, o, c)),
            (e = s[0]) && u.push(new Do(e, r, i, l, c));
        }
      return this;
    }),
    ($o.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new Do(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            c = (a + s) / 2,
            h = (u + l) / 2;
          (o = i[0]) && e.push(new Do(o, a, u, c, h)),
            (o = i[1]) && e.push(new Do(o, c, u, s, h)),
            (o = i[2]) && e.push(new Do(o, a, h, c, l)),
            (o = i[3]) && e.push(new Do(o, c, h, s, l));
        }
        r.push(n);
      }
  ...
  const Vo = (t, n, e, r, i, o) =>
    Math.sqrt((t - r) ** 2 + (n - i) ** 2 + (e - o) ** 2);
  function Xo(t) {
    return t[0];
  }
  function Go(t) {
  ...
  var Ko = (Wo.prototype = Zo.prototype);
  function Jo(t) {
    return function () {
      return t;
    };
  ...
  function ra(t) {
    ...
    function f(r) {
      for (var o = 0, s = t.length; o < h; ++o)
        for (var l, c, f, p, d, g = 0, y = 0, _ = 0, v = 0; g < s; ++g)
          (c = (l = t[g]).source),
            (y = (f = l.target).x + f.vx - c.x - c.vx || ta(u)),
            i > 1 && (_ = f.y + f.vy - c.y - c.vy || ta(u)),
            i > 2 && (v = f.z + f.vz - c.z - c.vz || ta(u)),
            (y *= p =
              (((p = Math.sqrt(y * y + _ * _ + v * v)) - e[g]) / p) * r * n[g]),
            (_ *= p),
            (v *= p),
            (f.vx -= y * (d = a[g])),
            i > 1 && (f.vy -= _ * d),
    ...
    function p() {
      if (r) {
        ...
        for (i = 0, o = new Array(l); i < c; ++i)
          ((u = t[i]).index = i),
            'object' != typeof u.source && (u.source = ea(h, u.source)),
            'object' != typeof u.target && (u.target = ea(h, u.target)),
        ...
        (n = new Array(c)), d(), (e = new Array(c)), g();
      }
    }
    function d() {
    ...
    return (
      ...
      (f.links = function (n) {
        return arguments.length ? ((t = n), p(), f) : t;
      }),
      (f.id = function (t) {
      ...
      (f.strength = function (t) {
        return arguments.length
          ? ((l = 'function' == typeof t ? t : Jo(+t)), d(), f)
          : l;
      }),
      (f.distance = function (t) {
        return arguments.length
          ? ((c = 'function' == typeof t ? t : Jo(+t)), g(), f)
          : c;
      }),
      f
    );
  ...
  (Ko.copy = function () {
    ...
    (Ko.add = function (t) {
      ...
      return Bo(this.cover(n, e, r), n, e, r, t);
    }),
    (Ko.addAll = function (t) {
      Array.isArray(t) || (t = Array.from(t));
      const n = t.length,
        e = new Float64Array(n),
      ...
      for (let o = 0; o < n; ++o) Bo(this, e[o], r[o], i[o], t[o]);
      return this;
    }),
    (Ko.cover = function (t, n, e) {
        ...
        if (
          ...
          if (x.length) {
            var b = (o + s) / 2,
              ...
              k = (u + c) / 2;
            m.push(
              new Ho(x[7], b, w, k, s, l, c),
              new Ho(x[6], o, w, k, b, l, c),
              new Ho(x[5], b, a, k, s, w, c),
              new Ho(x[4], o, a, k, b, w, c),
              new Ho(x[3], b, w, u, s, l, k),
              new Ho(x[2], o, w, u, b, l, k),
              new Ho(x[1], b, a, u, s, w, k),
              new Ho(x[0], o, a, u, b, w, k)
            ),
              (f = ((e >= k) << 2) | ((n >= w) << 1) | (t >= b)) &&
                ((h = m[m.length - 1]),
            ...
            var M = t - +this._x.call(null, x.data),
              A = n - +this._y.call(null, x.data),
              z = e - +this._z.call(null, x.data),
              S = M * M + A * A + z * z;
            if (S < r) {
              var E = Math.sqrt((r = S));
              (p = t - E),
    ...
    (Ko.findAllWithinRadius = function (t, n, e, r) {
      const i = [],
        o = t - r,
        a = n - r,
        u = e - r,
        ...
        c = e + r;
      return (
        this.visit((h, f, p, d, g, y, _) => {
          if (!h.length)
            do {
              const o = h.data;
              Vo(t, n, e, this._x(o), this._y(o), this._z(o)) <= r && i.push(o);
            } while ((h = h.next));
          return f > s || p > l || d > c || g < o || y < a || _ < u;
        }),
        i
      );
    }),
    (Ko.remove = function (t) {
      if (
        isNaN((o = +this._x.call(null, t))) ||
        isNaN((a = +this._y.call(null, t))) ||
    ...
    (Ko.visit = function (t) {
      ...
      for (
        c &&
        l.push(
          new Ho(c, this._x0, this._y0, this._z0, this._x1, this._y1, this._z1)
        );
        (n = l.pop());
        ...
        if (
          ...
          var h = (r + a) / 2,
            f = (i + u) / 2,
            p = (o + s) / 2;
          (e = c[7]) && l.push(new Ho(e, h, f, p, a, u, s)),
            (e = c[6]) && l.push(new Ho(e, r, f, p, h, u, s)),
            (e = c[5]) && l.push(new Ho(e, h, i, p, a, f, s)),
            (e = c[4]) && l.push(new Ho(e, r, i, p, h, f, s)),
            (e = c[3]) && l.push(new Ho(e, h, f, o, a, u, p)),
            (e = c[2]) && l.push(new Ho(e, r, f, o, h, u, p)),
            (e = c[1]) && l.push(new Ho(e, h, i, o, a, f, p)),
            (e = c[0]) && l.push(new Ho(e, r, i, o, h, f, p));
        }
      return this;
    }),
    (Ko.visitAfter = function (t) {
      var n,
        e = [],
        r = [];
      for (
        ...
        if (i.length) {
          var o,
            ...
            p = (u + c) / 2,
            d = (s + h) / 2;
          (o = i[0]) && e.push(new Ho(o, a, u, s, f, p, d)),
            (o = i[1]) && e.push(new Ho(o, f, u, s, l, p, d)),
            (o = i[2]) && e.push(new Ho(o, a, p, s, f, c, d)),
            (o = i[3]) && e.push(new Ho(o, f, p, s, l, c, d)),
            (o = i[4]) && e.push(new Ho(o, a, u, d, f, p, h)),
            (o = i[5]) && e.push(new Ho(o, f, u, d, l, p, h)),
            (o = i[6]) && e.push(new Ho(o, a, p, d, f, c, h)),
            (o = i[7]) && e.push(new Ho(o, f, p, d, l, c, h));
        }
        r.push(n);
      }
  ...
  var sa = Math.PI * (3 - Math.sqrt(5)),
    la = (20 * Math.PI) / (9 + Math.sqrt(221));
  function ca(t, n) {
    n = n || 2;
    var e,
    ...
    function p() {
      d(), h.call('tick', e), i < o && (c.stop(), h.call('end', e));
    }
    function d(n) {
      var o,
        c,
  ...
  function ha() {
      ...
      if ((_ * _) / l < v)
        return (
          v < s &&
            ...
            v < u && (v = Math.sqrt(u * v)),
            (e.vx += (d * t.value * i) / v),
            n > 1 && (e.vy += (g * t.value * i) / v),
            n > 2 && (e.vz += (y * t.value * i) / v)),
          !0
        );
      if (!(t.length || v >= s)) {
        (t.data !== e || t.next) &&
    ...
    return (
      ...
      (c.strength = function (t) {
        return arguments.length
          ? ((a = 'function' == typeof t ? t : Jo(+t)), h(), c)
          : a;
      }),
  ...
  const xa = Math.PI,
    ...
    za = {
      ...
      arcfn: function (t, n) {
        ...
        return void 0 !== e.z && (r += e.z * e.z), _a(r);
      },
      compute: function (t, n, e) {
        ...
        if (r < 4) {
          let n,
            ...
            c = 0;
          2 === r
            ? ((o = [o[0], o[1], o[2], Aa]), (n = s), (a = i * t * 2), (u = l))
            : 3 === r &&
      ...
      between: function (t, n, e) {
        return (
          (n <= t && t <= e) || za.approximately(t, n) || za.approximately(t, e)
        );
      },
      approximately: function (t, n, e) {
        return fa(t - n) <= (e || 1e-6);
      },
      length: function (t) {
        const n = za.Tvalues.length;
        let e = 0;
        for (let r, i = 0; i < n; i++)
          (r = 0.5 * za.Tvalues[i] + 0.5),
            (e += za.Cvalues[i] * za.arcfn(r, t));
        return 0.5 * e;
      },
      ...
      lli4: function (t, n, e, r) {
        const i = t.x,
          ...
          c = r.x,
          h = r.y;
        return za.lli8(i, o, a, u, s, l, c, h);
      },
      lli: function (t, n) {
        return za.lli4(t, t.c, n, n.c);
      },
      makeline: function (t, n) {
        return new Da(t.x, t.y, (t.x + n.x) / 2, (t.y + n.y) / 2, n.x, n.y);
      },
      findbbox: function (t) {
        let n = ka,
          e = ka,
      ...
      align: function (t, n) {
        const e = n.p1.x,
          r = n.p1.y,
          i = -ya(n.p2.y - r, n.p2.x - e);
        return t.map(function (t) {
          return {
            x: (t.x - e) * pa(i) - (t.y - r) * da(i),
            y: (t.x - e) * da(i) + (t.y - r) * pa(i),
          };
        });
      },
      roots: function (t, n) {
        ...
        if (za.approximately(s, 0)) {
          if (za.approximately(l, 0))
            return za.approximately(c, 0) ? [] : [-h / c].filter(i);
          const t = _a(c * c - 4 * l * h),
            n = 2 * l;
        ...
        {
          const t = _a(y);
          return (_ = ma(-g + t)), (v = ma(g + t)), [_ - v - l / 3].filter(i);
        }
      },
      droots: function (t) {
        if (3 === t.length) {
      ...
      curvature: function (t, n, e, r, i) {
        let o,
          ...
          l = 0,
          c = 0;
        const h = za.compute(t, n),
          f = za.compute(t, e),
          p = h.x * h.x + h.y * h.y;
        if (
          (r
            ? ((o = _a(
                va(h.y * f.z - f.y * h.z, 2) +
                  va(h.z * f.x - f.z * h.x, 2) +
                  va(h.x * f.y - f.x * h.y, 2)
              )),
              (a = va(p + h.z * h.z, 1.5)))
            : ((o = h.x * f.y - h.y * f.x), (a = va(p, 1.5))),
          0 === o || 0 === a)
        )
          return { k: 0, r: 0 };
        if (((l = o / a), (c = a / o), !i)) {
          const i = za.curvature(t - 0.001, n, e, r, !0).k,
            o = za.curvature(t + 0.001, n, e, r, !0).k;
          (s = (o - l + (l - i)) / 2), (u = (fa(o - l) + fa(l - i)) / 2);
        }
        return { k: l, r: c, dk: s, adk: u };
      },
      inflections: function (t) {
        if (t.length < 4) return [];
        const n = za.align(t, { p1: t[0], p2: t.slice(-1)[0] }),
          e = n[2].x * n[1].y,
          r = n[3].x * n[1].y,
          i = n[1].x * n[2].y,
      ...
      getccenter: function (t, n, e) {
        const r = n.x - t.x,
          ...
          _ = p + l,
          v = d + c,
          m = za.lli8(h, f, g, y, p, d, _, v),
          x = za.dist(m, t);
        let b,
          w = ya(t.y - m.y, t.x - m.x),
          k = ya(n.y - m.y, n.x - m.x),
          M = ya(e.y - m.y, e.x - m.x);
        return (
          w < M
            ? ((w > k || k > M) && (w += ba),
              w > M && ((b = M), (M = w), (w = b)))
  ...
  class Da {
    constructor(t) {
      ...
      const c = za.align(a, { p1: a[0], p2: a[s] }),
        h = za.dist(a[0], a[s]);
      (this._linear = c.reduce((t, n) => t + Ea(n.y), 0) < h / 50),
        (this._lut = []),
        (this._t1 = 0),
        (this._t2 = 1),
        this.update();
    ...
    static quadraticFromPoints(t, n, e, r) {
      if ((void 0 === r && (r = 0.5), 0 === r)) return new Da(n, n, e);
      if (1 === r) return new Da(t, n, n);
      const i = Da.getABC(2, t, n, e, r);
      return new Da(t, i.A, e);
    }
    static cubicFromPoints(t, n, e, r, i) {
      void 0 === r && (r = 0.5);
      const o = Da.getABC(3, t, n, e, r);
    ...
    update() {
      (this._lut = []),
        (this.dpoints = za.derive(this.points, this._3d)),
    ...
    getABC(t, n) {
      ...
      return Da.getABC(this.order, e, n, r, t);
    }
    getLUT(t) {
    ...
    on(n, e) {
      ...
      for (let t, o = 0, a = 0; o < r.length; o++)
        (t = r[o]), za.dist(t, n) < e && (i.push(t), (a += o / r.length));
    ...
    project(t) {
      ...
      l += 1;
      for (let n; c < a + u; c += u)
        (s = this.compute(c)), (n = za.dist(t, s)), n < l && ((l = n), (h = c));
      return (
        (h = h < 0 ? 0 : h > 1 ? 1 : h),
        (s = this.compute(h)),
        (s.t = h),
    ...
    compute(t) {
      return this.ratios
        ? za.computeWithRatios(t, this.points, this.ratios, this._3d)
        : za.compute(t, this.points, this._3d, this.ratios);
    }
    raise() {
      const t = this.points,
        n = [t[0]],
    ...
    align() {
      let t = this.points;
      return new Da(za.align(t, { p1: t[0], p2: t[t.length - 1] }));
    }
    curvature(t) {
    ...
    __normal2(t) {
      const n = this.derivative(t),
        e = Ta(n.x * n.x + n.y * n.y);
      return { t: t, x: -n.y / e, y: n.x / e };
    }
    __normal3(t) {
      const n = this.derivative(t),
        e = this.derivative(t + 0.01),
        r = Ta(n.x * n.x + n.y * n.y + n.z * n.z),
        i = Ta(e.x * e.x + e.y * e.y + e.z * e.z);
    ...
    hull(t) {
      ...
      for (
        ...
        for (let o, a = 0, u = n.length - 1; a < u; a++)
          (o = za.lerp(t, n[a], n[a + 1])), (r[i++] = o), e.push(o);
        n = e;
      }
      return r;
    }
      ...
      const e = this.hull(t),
        r = {
          left:
            2 === this.order
              ? new Da([e[0], e[3], e[5]])
              : new Da([e[0], e[4], e[7], e[9]]),
          right:
            2 === this.order
              ? new Da([e[5], e[4], e[2]])
              : new Da([e[9], e[8], e[6], e[3]]),
          span: e,
        };
      return (
        (r.left._t1 = za.map(0, 0, 1, this._t1, this._t2)),
        (r.left._t2 = za.map(t, 0, 1, this._t1, this._t2)),
        (r.right._t1 = za.map(t, 0, 1, this._t1, this._t2)),
        (r.right._t2 = za.map(1, 0, 1, this._t1, this._t2)),
        n ? ((n = za.map(n, t, 1, 0, 1)), r.right.split(n).left) : r
      );
    }
    extrema() {
      const t = {};
      ...
      return (
        ...
        (t.values = n.sort(za.numberSort).filter(function (t, e) {
    ...
    simple() {
      ...
      return this._3d && (e += t.z * n.z), Ea(ja(e)) < Ra / 3;
    }
    reduce() {
      let t,
        n,
          ...
          for (e = 0, r = 0; r <= 1; )
            for (r = e + i; r <= 1.01; r += i)
              if (((n = t.split(e, r)), !n.simple())) {
                if (((r -= i), Ea(e - r) < i)) return [];
                (n = t.split(e, r)),
                  (n._t1 = za.map(e, 0, 1, t._t1, t._t2)),
                  (n._t2 = za.map(r, 0, 1, t._t1, t._t2)),
                  a.push(n),
                  (e = r);
                break;
              }
    ...
    outline(t, n, e, r) {
      if (((n = void 0 === n ? t : n), this._linear)) {
        ...
        (u = { x: o.x - i.x * n, y: o.y - i.y * n }),
          ...
          (s = { x: (u.x + l.x) / 2, y: (u.y + l.y) / 2 });
        const h = [l, s, u],
          f = za.makeline(h[2], c[0]),
          p = za.makeline(c[2], h[0]),
          d = [f, new Da(c), p, new Da(h)];
        return new Sa(d);
      }
      const i = this.reduce(),
        o = i.length,
      ...
      const p = a[0].points[0],
        ...
        _ = za.makeline(g, p),
        v = za.makeline(d, y),
        m = [_].concat(a).concat([v]).concat(s);
      return new Sa(m);
    }
    outlineshapes(t, n, e) {
      n = n || t;
          ...
          if (
            ...
            if (i >= 1) {
              if (((u.interval.end = d = 1), (s = u), i > 1)) {
                let t = { x: u.x + u.r * Oa(u.e), y: u.y + u.r * Na(u.e) };
                u.e += za.angle({ x: u.x, y: u.y }, t, this.get(1));
              }
              break;
            }
            i += (i - r) / 2;
  ...
  var $a = function () {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [],
      ...
      i = (n instanceof Array ? (n.length ? n : [void 0]) : [n]).map(function (
        t
      ) {
                ...
                c = (function (t, n) {
                  ...
                  if (Object.getOwnPropertySymbols) {
                    ...
                    for (r = 0; r < o.length; r++)
                      (e = o[r]),
                        n.includes(e) ||
                          ({}.propertyIsEnumerable.call(t, e) && (i[e] = t[e]));
                  }
                  return i;
                })(s, [u].map(La));
              (a = l), (o = c);
  ...
  var Ya = function (t, n) {
    ...
    Wa = function (t, n) {
      if (!n.isShadow) {
        var e = Ir(n.linkDirectionalParticles);
        n.graphData.links.forEach(function (t) {
          var n = Math.round(Math.abs(e(t)));
          n
            ? (t.__photons = s(Array(n)).map(function () {
                return {};
              }))
            : delete t.__photons;
        });
      ...
      methods: {
        ...
        tickFrame: function (t) {
          ...
          return (
            ...
            (function () {
              var n = Ir(t.linkVisibility),
                e = Ir(t.linkColor),
                r = Ir(t.linkWidth),
                i = Ir(t.linkLineDash),
                o = Ir(t.linkCurvature),
                a = Ir(t.linkCanvasObjectMode),
                l = t.ctx,
                c = 2 * t.isShadow,
              ...
              if (t.linkCanvasObject) {
                var g = [],
                  y = [];
                h.forEach(function (t) {
                  return ({ before: f, after: p, replace: g }[a(t)] || y).push(
                    t
                  );
                }),
                  (d = [].concat(s(f), p, y)),
              ...
              var _ = $a(d, [e, r, i]);
              l.save(),
                Object.entries(_).forEach(function (n) {
                  var e = u(n, 2),
                    r = e[0],
                    o = e[1],
            ...
            !t.isShadow &&
              ((n = Ir(t.linkDirectionalArrowLength)),
              (r = Ir(t.linkDirectionalArrowRelPos)),
              (i = Ir(t.linkVisibility)),
              (o = Ir(t.linkDirectionalArrowColor || t.linkColor)),
              (a = Ir(t.nodeVal)),
              (l = t.ctx).save(),
              t.graphData.links.filter(i).forEach(function (i) {
                ...
                if (u && !(u < 0)) {
                  ...
                  if (
                    ...
                    var f = Math.sqrt(Math.max(0, a(c) || 1)) * t.nodeRelSize,
                      p = Math.sqrt(Math.max(0, a(h) || 1)) * t.nodeRelSize,
                      d = Math.min(1, Math.max(0, r(i))),
                      ...
                      _ =
                        ...
                        e(
                          Da,
                          [c.x, c.y].concat(s(i.__controlPoints), [h.x, h.y])
                        ),
                      v = _
                        ? function (t) {
                            return _.get(t);
                    ...
                    l.beginPath(),
                      l.moveTo(b.x, b.y),
                      l.lineTo(w.x + y * Math.cos(M), w.y + y * Math.sin(M)),
                      l.lineTo(k.x, k.y),
                      l.lineTo(w.x - y * Math.cos(M), w.y - y * Math.sin(M)),
                      (l.fillStyle = g),
                      l.fill();
            ...
            !t.isShadow &&
              (function () {
                var n = Ir(t.linkDirectionalParticles),
                  r = Ir(t.linkDirectionalParticleSpeed),
                  i = Ir(t.linkDirectionalParticleWidth),
                  o = Ir(t.linkVisibility),
                  a = Ir(t.linkDirectionalParticleColor || t.linkColor),
                  u = t.ctx;
                u.save(),
                  t.graphData.links.filter(o).forEach(function (o) {
                    var l = n(o);
                    if (o.hasOwnProperty('__photons') && o.__photons.length) {
                      ...
                      if (
                        ...
                        var y = o.__controlPoints
                            ? e(
                                Da,
                                [c.x, c.y].concat(s(o.__controlPoints), [
                                  h.x,
                                  h.y,
                                ])
                              )
                        ...
                        p.forEach(function (t) {
                          ...
                          u.beginPath(),
                            u.arc(r.x, r.y, d, 0, 2 * Math.PI, !1),
                            u.fill();
                        }),
                          v &&
                            (o.__photons = o.__photons.filter(function (t) {
            ...
            (function () {
              var n = Ir(t.nodeVisibility),
                e = Ir(t.nodeVal),
                r = Ir(t.nodeColor),
                i = Ir(t.nodeCanvasObjectMode),
                o = t.ctx,
      ...
      update: function (t, n) {
        (t.engineRunning = !1),
          ...
          null !== t.nodeAutoColorBy &&
            Ga(t.graphData.nodes, Ir(t.nodeAutoColorBy), t.nodeColor),
          null !== t.linkAutoColorBy &&
            Ga(t.graphData.links, Ir(t.linkAutoColorBy), t.linkColor),
        ...
        var i =
            ...
            (function (t, n) {
              var e = t.nodes,
                ...
                p = {};
              e.forEach(function (t) {
                return (p[n(t)] = { data: t, out: [], depth: -1, skip: !c(t) });
              }),
                  ...
                  for (
                    var r =
                      ...
                      o = function () {
                        ...
                        if (-1 !== r.indexOf(o)) {
                          var u = []
                            .concat(s(r.slice(r.indexOf(o))), [o])
                            .map(function (t) {
                              return n(t.data);
                            });
                          return (
                        ...
                        i > o.depth &&
                          ((o.depth = i),
                          t(o.out, [].concat(s(r), [o]), i + (o.skip ? 0 : 1)));
                      },
                      a = 0,
                      u = e.length;
                    a < u;
          ...
          o = Math.max.apply(Math, s(Object.values(i || []))),
          a =
            t.dagLevelDistance ||
            ...
            ? (function (t, n, e, r) {
                ...
                return (
                  ...
                  (l.strength = function (t) {
                    return arguments.length
                      ? ((s = 'function' == typeof t ? t : Jo(+t)), c(), l)
                      : s;
                  }),
                  (l.radius = function (n) {
                    return arguments.length
                      ? ((t = 'function' == typeof n ? n : Jo(+n)), c(), l)
                      : t;
                  }),
                  (l.x = function (t) {
                ...
                var e = i[n[t.nodeId]] || -1;
                return ('radialin' === t.dagMode ? o - e : e) * a;
              }).strength(function (n) {
  ...
  var Ka = Qa('forceGraph', Za),
    Ja = Qa(['forceGraph', 'shadowGraph'], Za),
      ...
      s(
        ...
        s(
          [
            ...
            return r({}, t, Ja.linkProp(t));
          })
        )
      )
    ),
    nu = Object.assign.apply(
      Object,
      s(
        ['d3Force', 'd3ReheatSimulation', 'emitParticle'].map(function (t) {
          return r({}, t, Ka.linkMethod(t));
        })
      )
    );
  function eu(t) {
  ...
  function iu(t, n, e) {
    t.save(), ru(t), t.clearRect(0, 0, n, e), t.restore();
  }
  var ou = Dr({
    props: a(
      {
    ...
    init: function (t, n) {
      ...
      var i = n.canvas.getContext('2d'),
        ...
        s = function () {
          var t = null,
            ...
            r =
              u.x > 0 && u.y > 0
                ? o.getImageData(u.x * e, u.y * e, 1, 1)
                : null;
      ...
      kt(n.canvas).call(
        (function () {
          ...
          function p(a, u) {
            if (!r && i.call(this, a, u)) {
              ...
              s &&
                (kt(a.view)
                  .on('mousemove.drag', d, Ot)
                  .on('mouseup.drag', g, Ot),
                Tt(a.view),
                Nt(a),
                (e = !1),
                (t = a.clientX),
          ...
          function g(t) {
            kt(t.view).on('mousemove.drag mouseup.drag', null),
              Rt(t.view, e),
              jt(t),
              s.mouse('end', t);
          }
          ...
          function _(t) {
            var n,
              ...
              i = r.length;
            for (n = 0; n < i; ++n)
              (e = s[r[n].identifier]) && (jt(t), e('drag', t, r[n]));
          }
          function v(t) {
            var n,
              e,
            ...
            for (
              ...
              (e = s[i[n].identifier]) && (Nt(t), e('end', t, i[n]));
          }
          ...
          return (
            (f.filter = function (t) {
              return arguments.length
                ? ((i = 'function' == typeof t ? t : Dt(!!t)), f)
                : i;
            }),
            (f.container = function (t) {
              return arguments.length
                ? ((o = 'function' == typeof t ? t : Dt(t)), f)
                : o;
            }),
            (f.subject = function (t) {
              return arguments.length
                ? ((a = 'function' == typeof t ? t : Dt(t)), f)
                : a;
            }),
            (f.touchable = function (t) {
              return arguments.length
                ? ((u = 'function' == typeof t ? t : Dt(!!t)), f)
                : u;
            }),
            (f.on = function () {
        ...
        n.zoom((n.zoom.__baseElem = kt(n.canvas))),
        ...
        n.zoom
          .filter(function (t) {
            return (
              ...
              ('wheel' !== t.type || Ir(n.enableZoomInteraction)(t)) &&
              ('wheel' === t.type || Ir(n.enablePanInteraction)(t))
            );
          })
          .on('zoom', function (t) {
            var r = t.transform;
            [i, o].forEach(function (t) {
              ru(t), t.translate(r.x, r.y), t.scale(r.k, r.k);
            }),
              (n.isPointerDragging = !0),
              n.onZoom && n.onZoom(a(a({}, r), e.centerAt())),
              (n.needsRedraw = !0);
          })
          .on('end', function (t) {
            (n.isPointerDragging = !1),
              n.onZoomEnd && n.onZoomEnd(a(a({}, t.transform), e.centerAt()));
          }),
        eu(n),
        n.forceGraph
        ...
        ['pointermove', 'pointerdown'].forEach(function (t) {
          return r.addEventListener(
            ...
            function (e) {
              ...
              (u.x = e.pageX - s.left), (u.y = e.pageY - s.top);
            },
            { passive: !0 }
          );
        }),
      ...
      var l = (function (t, n, e) {
        ...
        return (
          ...
          kr(t, n, { leading: r, maxWait: n, trailing: i })
        );
      })(function () {
        iu(o, n.width, n.height),
          n.shadowGraph.linkWidth(function (t) {
            return Ir(n.linkWidth)(t) + n.linkHoverPrecision;
          });
        var t = Fe(n.canvas);
        ...
        (this._animationCycle = function t() {
          ...
          if (((n.needsRedraw = !1), n.enablePointerInteraction)) {
            ...
            if (r !== n.hoverObj) {
              ...
              if (u) {
                var h = n['on'.concat(u, 'Hover')];
                h && h(r.d, a === u ? o.d : null);
              }
              n.tooltip.content(
                (r && Ir(n[''.concat(r.type.toLowerCase(), 'Label')])(r.d)) ||
                  null
              ),
                n.canvas.classList[
          ...
          if (e) {
            iu(i, n.width, n.height);
            var f = Fe(n.canvas).k;
            n.onRenderFramePre && n.onRenderFramePre(i, f),
              n.forceGraph.globalScale(f).tickFrame(),
              n.onRenderFramePost && n.onRenderFramePost(i, f);
          }
          n.tweenGroup.update(),
            (n.animationFrameRequestId = requestAnimationFrame(t));
        })();
    },
    update: function (t) {},
  });
